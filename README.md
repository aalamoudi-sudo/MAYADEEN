...
- `data/procurement_requests_template.csv`: template for the Procurement Center register.
- `data/permits_register_template.csv`: template for the Permits Center register.
- `data/change_orders_template.csv`: template for the Change Orders Center register.
- `data/automation_audit_log_template.csv`: template for automation activity logging.
- `data/escalation_records_template.csv`: template for the Escalation Center register.
- `data/workflow_ownership_matrix_template.csv`: template for workflow ownership, SLA, and escalation rules.
- `data/person_performance_template.csv`: template for operational person-performance snapshots.
- `data/vendor_control_template.csv`: template for Vendor Control Center rollups.
- `data/evidence_center_template.csv`: template for evidence and attachments.
- `data/issues_incidents_template.csv`: template for issues/incidents.
- `data/vendor_violations_template.csv`: template for vendor violations.
- `data/decision_log_template.csv`: template for linked decisions.
...
8. Operational Centers, Workflows, and Automation Layer
...
- `docs/PHASE8_OPERATIONAL_CENTERS.md`
- `docs/ADVANCED_OPERATIONAL_EXTENSIONS.md`
