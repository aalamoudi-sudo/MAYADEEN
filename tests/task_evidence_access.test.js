...
assert.match(frontendSource, /const visibleColumns=\(canViewCompletionEvidence\(\)\?20:19\)/, 'empty-table colspan must track permission and the visible task columns');
