...
assert.match(frontendSource, /const visibleColumns=\(canViewCompletionEvidence\(\)\?13:12\)/, 'empty-table colspan must track permission and the visible task columns');
