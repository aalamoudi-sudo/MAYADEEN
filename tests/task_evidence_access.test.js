...
assert.match(frontendSource, /const visibleColumns=\(canViewCompletionEvidence\(\)\?17:16\)/, 'empty-table colspan must track permission and the visible task columns');
