...
assert.match(frontendSource, /const visibleColumns=\(canViewCompletionEvidence\(\)\?21:20\)/, 'empty-table colspan must track permission and the visible task columns');
