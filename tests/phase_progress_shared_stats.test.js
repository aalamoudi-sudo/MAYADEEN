...
assert.match(renderBody, /getScheduleProgressMetrics\(\)/);
assert.match(renderBody, /phaseUnclassified/);
assert.match(renderBody, /PROJECT_PHASE_UNSPECIFIED/);
assert.match(renderBody, /التقدم الفعلي العام/);
assert.match(renderBody, /التقدم المخطط العام/);
assert.match(renderBody, /الانحراف/);
assert.match(renderBody, /المرحلة الحالية/);
assert.match(renderBody, /المهام/);
