...
const derive = Function(`${functionSource('deriveDataQualityMetrics_')}; return deriveDataQualityMetrics_;`)();
const issues = [
  {severity:'حرج',status:'مفتوحة',last_seen_at:'2026-07-27T08:00:00Z'},
  {severity:'مرتفع',status:'قيد المعالجة',last_seen_at:'2026-07-28T08:00:00Z'},
  {severity:'متوسط',status:'تم الحل',last_seen_at:'2026-07-26T08:00:00Z'},
  {severity:'منخفض',status:'مفتوحة',last_seen_at:'2026-07-25T08:00:00Z'}
];
